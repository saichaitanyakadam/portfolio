...
const About = () => {
  ...
  return (
    <div className="flex flex-col gap-5 w-full">
      ...
      >
        <div className="mb-5">
          <h2 className="text-4xl font-serif mb-2">Personal Details</h2>
          <hr className="border-gray-200" />
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-2">
            {PersonalDetails.map((item) => (
              <div key={item.id} className="w-full">
                <p className="font-[300] text-md mb-1">{item.label}</p>
                <p className="border border-gray-500 rounded-md py-2 px-5 overflow-x-auto">
                  {item.content}
                </p>
              </div>
            ))}
      ...
      <div
        className={`${
          nightMode ? "bg-[#333]" : "bg-white"
        } flex flex-col p-5 rounded-lg lg:p-10 shadow-lg w-full border border-gray-200`}
      >
        <div>
          <h2 className="text-4xl font-serif mb-2">Education</h2>
          <hr className="border-gray-200" />
                ...
                <div className="flex justify-between items-center">
                  ...
                  {education.score && (
                    <div className="text-right text-sm font-[200]">
                      ...
                      <p>
                        {education.score}/{education.overallScore}
                      </p>
                    </div>
                  )}
                </div>
      ...
      <div className="flex justify-center gap-5 text-5xl ">
        ...
        <a
          href="https://github.com/saichaitanyakadam"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FaGithubSquare />
